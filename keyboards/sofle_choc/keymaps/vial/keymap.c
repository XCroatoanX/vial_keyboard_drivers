...
[0] = LAYOUT(
    ...
    KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,    KC_MPLY,   XXXXXXX,KC_N,     KC_M,     KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                      KC_LCTL, KC_LGUI, KC_LALT, MO(1), KC_ENT,    KC_SPC, MO(2),  KC_RALT,  KC_RGUI, KC_RCTL
),
...
// WARNING, THE LEFT ENCODER MUST BE FIRST VALUE UP/RIGHT, THEN DOWN/LEFT, OTHERWISE IT WILL BE INVERTED
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    [0] = { ENCODER_CCW_CW(KC_VOLU, KC_VOLD), ENCODER_CCW_CW(MS_WHLD, MS_WHLU) },
    [1] = { ENCODER_CCW_CW(KC_TRNS, KC_TRNS),   ENCODER_CCW_CW(MS_WHLR, MS_WHLL) },
    [2] = { ENCODER_CCW_CW(KC_MNXT, KC_MPRV),    ENCODER_CCW_CW(KC_TRNS, KC_TRNS) }
};
